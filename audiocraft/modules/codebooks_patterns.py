...
class Pattern:
    ...
    def _build_pattern_sequence_scatter_indexes(self, timesteps: int, n_q: int, keep_only_valid_steps: bool,
        ...
        #print(indexes.shape)
        #print(mask.shape)
        #print("build_pattern_sequence_scatter_indexes")
        #exit()
        return indexes, mask
    ...
    def build_pattern_sequence(self, z: torch.Tensor, special_token: int, keep_only_valid_steps: bool = False):
        ...
        #print("Initial indexes shape:", indexes.shape)
        #print("Positions filled with special tokens:", np.where(indexes == n_q * sequence_steps))

        # After the loop:
        #print("Final indexes shape:", indexes.shape)
        #print("Unused positions (extra tokens):", np.where(mask == 0))
        #print("***********")
        #exit()
        z = z.view(B, -1)
