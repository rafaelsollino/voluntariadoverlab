...
class VideoMusicGen(BaseGenModel):
    ...
    def __init__(self, name: str, compression_model: CompressionModel, lm: LMModel,
        ...
        self.set_generation_params(duration=max_duration)  # default duration
    ...
    def get_pretrained(name: str = 'facebook/musicgen-melody', device=None):
        ...
        if name == 'debug':
            ...
            return MyMusicGen(name, compression_model, lm, max_duration=30)
        ...
        return MyMusicGen(name, compression_model, lm)
    ...
    def _generate_tokens(self, attributes: tp.List[ConditioningAttributes],
                         prompt_tokens: tp.Optional[torch.Tensor], video_features, progress: bool = False) -> torch.Tensor:
        ...
        if self.duration <= self.max_duration:
            ...
            with self.autocast:
                gen_tokens = self.lm.generate(
                    prompt_tokens, video_features, attributes,
