...
def load_lm_model(pretrained_dict, file_or_url_or_id: tp.Union[Path, str], device='cpu', cache_dir: tp.Optional[str] = None):
    ...
    lm_dict = model.state_dict()
    model_dict = {}
    model_dict.update(lm_dict)
