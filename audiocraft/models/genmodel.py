...
class BaseGenModel(ABC):
    ...
    def generate_continuation(self, prompt: torch.Tensor, prompt_sample_rate: int,
                              descriptions: tp.Optional[tp.List[tp.Optional[str]]] = None, video_features = None,
        ...
        tokens = self._generate_tokens(attributes, prompt_tokens, video_features, progress)
        if return_tokens:
            return self.generate_audio(tokens), tokens
